...
/** StAX-based Elem parser */
final class ElemParser(val xmlInputFactory: XMLInputFactory) {

  def parse(is: jio.InputStream): Elem = {
...
object ElemParser {
  ...
  def newInstance(): ElemParser = new ElemParser(XMLInputFactory.newFactory)
}
