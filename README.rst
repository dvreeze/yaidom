...
Yaidom versions can be found in the Maven central repository. Assuming version 0.6.4, yaidom can be added as dependency
as follows (in an SBT or Maven build):

**SBT**::

    libraryDependencies += "eu.cdevreeze.yaidom" %% "yaidom" % "0.6.4"
