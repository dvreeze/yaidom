...
/**
 * Like `ResolvedElems`, but supporting static imports in Java. Easy to use in Java 8 code.
 *
 * @author Chris de Vreeze
 */
object ResolvedElemOps {

  type E = Elem

  private val delegate = ResolvedElems.getInstance
