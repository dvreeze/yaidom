...
/**
 * XML Base test case using an ContextAwareClarkElemApi.
 *
 * @author Chris de Vreeze
 */
abstract class AbstractXmlBaseOnContextAwareClarkElemApiTest extends Suite {

  private val XmlBaseEName = EName("http://www.w3.org/XML/1998/namespace", "base")
  private val XLinkNs = "http://www.w3.org/1999/xlink"

  type E <: ContextAwareClarkElemApi[E]
  ...
  private def testXmlBaseProperty1(elem: E): Unit = {
    ...
    val expectedBaseUri =
      XmlBaseSupport.findBaseUriByDocUriAndContextPath(elem.docUriOption, elem.contextPath)(resolveUri).get
  ...
  private def testXmlBaseProperty2(elem: E, docElem: E): Unit = {
    ...
    val parentBaseUriOption =
      elem.parentContextPath.entries.foldLeft(elem.docUriOption) { (baseUriOption, entry) =>
        XmlBaseSupport.findBaseUriByParentBaseUri(baseUriOption, entry)(resolveUri)
      }
