...
/**
 * Query test case for lazy indexed Elems.
 *
...
class QueryTest extends AbstractElemLikeQueryTest {
  ...
  @Test def testQueryBooksOrderedByPrice(): Unit = {
    ...
    def cheaper(book1: LazyIndexedScopedElem[simple.Elem], book2: LazyIndexedScopedElem[simple.Elem]): Boolean = {
  ...
  @Test def testQueryInvertedBookstore(): Unit = {
    ...
    val authorsWithBooks =
      for {
        ...
        val author: LazyIndexedScopedElem[simple.Elem] = {
          val result = for {
    ...
    val invertedBookstore: LazyIndexedScopedElem[simple.Elem] =
      LazyIndexedScopedElem[simple.Elem](
        Some(bookstore.docUriOption.get),
  ...
  @Test def testTransformLeavingOutPrices(): Unit = {
    ...
    val bookstoreWithoutPrices: LazyIndexedScopedElem[simple.Elem] = {
      ...
      LazyIndexedScopedElem[simple.Elem](Some(bookstore.docUriOption.get), result)
    }
  ...
  protected final val bookstore: LazyIndexedScopedElem[simple.Elem] = {
    import NodeBuilder._
    ...
    LazyIndexedScopedElem[simple.Elem](Some(new URI("http://bookstore.xml")), result)
  }
