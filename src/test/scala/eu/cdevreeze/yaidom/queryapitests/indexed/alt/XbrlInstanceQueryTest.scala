...
package eu.cdevreeze.yaidom.queryapitests.indexed.alt

import org.junit.runner.RunWith
import org.scalatest.junit.JUnitRunner

import eu.cdevreeze.yaidom.indexed.alt.Elem
import eu.cdevreeze.yaidom.parse.DocumentParserUsingDom
import eu.cdevreeze.yaidom.queryapitests.AbstractXbrlInstanceQueryTest
import eu.cdevreeze.yaidom.resolved

/**
 * XBRL instance query test case for indexed.alt elements.
 *
