...
import eu.cdevreeze.yaidom.docaware.alt.Elem
import eu.cdevreeze.yaidom.queryapitests.AbstractXQuery3UseCasesTest
import eu.cdevreeze.yaidom.simple

/**
 * AbstractXQuery3UseCasesTest for docaware.alt Elems.
 *
...
class XQuery3UseCasesTest extends AbstractXQuery3UseCasesTest {
  ...
  protected val productsElem: E = {
    ...
    Elem(new URI(""), convertToElem(xml))
  }
  ...
  protected def fromSimpleElem(elem: simple.Elem): E = Elem(new URI(""), elem)
}
