...
class ScopedElemLikeQueryTest extends AbstractScopedElemLikeQueryTest {
  ...
  protected final val xsdSchemaElem: LazyIndexedScopedElem[simple.Elem] = {
    ...
    LazyIndexedScopedElem[simple.Elem](Some(new java.net.URI("")), convert.DomConversions.convertToElem(domDoc.getDocumentElement(), Scope.Empty))
  }
